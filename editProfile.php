...
<body>
    ...
    <div class="wrapper"> <!-- div class wrapper starts here -->
        ...
        <form action="#">  <!--link to confirmation page when formed is filled out -->
         ...
         <h3 id = "card-header"  class = "card-header"> Card Information 1</h3>
         ...
         <div class = "input-box card-information"  id ="paymentCards">  <!-- Card Info Fields start here--> <!-- div class payment cards starts here -->
            ...
            <div class="field">
                <input type= "text" placeholder=" Card Type"  name = "card-type[0]" >
                 <!-- user icon from fontawesome -->
            ...
            <button type="button" class="delete-payment" onclick="deletePaymentCard(this)">Delete</button>
  ...
  <h3 id = "card-header" class = "card-header"> Card Information 2</h3>
...
<div class = "input-box card-information"  id ="paymentCards">  <!-- Card Info Fields start here--> <!-- div class payment cards starts here -->
  ...
  <div class="field">
      <input type= "text" placeholder=" Card Type"  name = "card-type[1]" >
       <!-- user icon from fontawesome -->
       <svg class = "icon"xmlns="http://www.w3.org/2000/svg"  width ="30" height ="20" fill="#FFFFFF" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
       <path d="M64 32C28.7 32 0 60.7 0 96v32H576V96c0-35.3-28.7-64-64-64H64zM576 224H0V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V224zM112 352h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H240c-8.8 0-16-7.2-16-16z"/></svg>
  </div>
  ...
  <button type="button" class="delete-payment" onclick="deletePaymentCard(this)">Delete</button>
         ...
         <h3 id = "card-header" class = "card-header"> Card Information 3 </h3>
...
<div class = "input-box card-information"  id ="paymentCards">  <!-- Card Info Fields start here--> <!-- div class payment cards starts here -->
  ...
  <div class="field">
      <input type= "text" placeholder=" Card Type"  name = "card-type[2]" >
       <!-- user icon from fontawesome -->
       <svg class = "icon"xmlns="http://www.w3.org/2000/svg"  width ="30" height ="20" fill="#FFFFFF" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
       <path d="M64 32C28.7 32 0 60.7 0 96v32H576V96c0-35.3-28.7-64-64-64H64zM576 224H0V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V224zM112 352h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H112c-8.8 0-16-7.2-16-16s7.2-16 16-16zm112 16c0-8.8 7.2-16 16-16H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H240c-8.8 0-16-7.2-16-16z"/></svg>
  </div>
