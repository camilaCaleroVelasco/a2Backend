    ...
    <div class="wrapper"> <!-- div class wrapper starts here -->
        ...
        <form action="promotionProcess.php" method="post"> <!--push info to the DB -->
            ...
            <div class="input-box"> <!-- div class input-box starts here -->
                ...
                <div class="field">
                    <input type="text" placeholder="Promotion Name" name="promotion-name" required>
                ...
                <div class="field">
                    <input type="number" placeholder=" Promotion Amount (%)" name="promotion-amount" required>
            ...
            <div class=" input-box date-information"> <!-- Fields start here-->
                ...
                <div class="field">
                    <input type="number" placeholder="Start Day" name="start-day" required>
                    <!-- user icon from fontawesome -->
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="#FFFFFF"
                        viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <div class="field">
                    <input type="number" placeholder="End Month" name="end-month" required>
                    <!-- user icon from fontawesome -->
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="#FFFFFF"
                        viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                ...
                <div class="field">
                    <input type="number" placeholder="End Day" name="end-day" required>
                    <!-- user icon from fontawesome -->
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="#FFFFFF"
                        viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
