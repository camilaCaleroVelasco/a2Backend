    ...
    <div class="wrapper">
        ...
        <form action="#" method="post">
            ...
            <div class=" input-box card-information">
                ...
                <a href=" editProfile.php"> <button class="button" id="submit" name="submit" style = "margin-left: 60px;  width: 200px"> Back </button> </a>
                <button type="submit" class="button" id="submit" name="submit" style = "margin-left: 150px;  width: 200px"> Enter Payment </button>
